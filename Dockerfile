...
# Install all dependencies (ignore scripts - we'll build after copying source)
...
# Install production dependencies only (ignore scripts since we copy pre-built dist)
